...
public class EquipmentDTO {
	...
	public String getCedetail() {
		return cedetail;
	}
	public void setCedetail(String cedetail) {
		this.cedetail = cedetail;
	}
	
	@Override
	public String toString() {
		return "EquipmentDTO [equipmentcode=" + equipmentcode + ", equipmentname=" + equipmentname
				...
				+ equipmentcount + ", contractcode=" + contractcode + ", cedetail=" + cedetail + "]";
	}
