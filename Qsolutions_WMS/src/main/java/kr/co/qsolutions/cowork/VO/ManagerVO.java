...
public class ManagerVO {
	...
	public String toString() {
		return "ManagerVO [managerid=" + managerid + ", managername=" + managername + ", managermobile=" + managermobile
				+ ", manageremail=" + manageremail + ", managerdeptname=" + managerdeptname + ", managerpositioncode="
				+ managerpositioncode + ", positionname=" + positionname + ", managercompanycode=" + managercompanycode
