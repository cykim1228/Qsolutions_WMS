...
<form action="${pageContext.request.contextPath}/Company/Insert" method="post" id="insertData" name="insertData">
	...
	<div class="viewListCenter">
      ...
      <!-- <select class="form-control choices__input is-hidden" name="choices-multiple-remove-button" id="choices-multiple-remove-button" placeholder="This is a placeholder" multiple="" tabindex="-1" aria-hidden="true" data-choice="active">
      <option value="Choice 4" selected="">
      Choice 4
      </option>
      </select>
      <div class="choices__list choices__list--multiple">
      <div class="choices__item choices__item--selectable" data-item="" data-id="12" data-value="Choice 4" data-deletable="" aria-selected="true">
          Choice 4
      <button type="button" class="choices__button" data-button="" aria-label="Remove item: 'Choice 4'">
            Remove item
      </button>
      </div>
      </div> -->
